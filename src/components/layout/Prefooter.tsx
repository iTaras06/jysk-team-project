...
export default function Prefooter() {
    return (
    <section className="w-full mx-auto h-[638px] text-[rgba(35, 31, 32, 1)]">

    <div className="h-[198px] border-b border-black/50 bg-white shadow-[0px_4px_10px_rgba(0,0,0,0.25)]  max-[768px]:h-[300px] max-[640px]:h-[400px]">
        ...
        <div className="mx-auto flex h-full items-center justify-between px-[10%]
            ...
            <div className="flex w-[374px] flex-col items-center text-center">
                <Image src="/icons/chair.png" alt="chair"
                    width={66}
                    height={52}
                    className="shrink-0 max-[640px]:h-[41px] max-[640px]:w-[52px]"/>

                <p className="mt-4 text-[15px] leading-[1.2]
                    max-[768px]:text-[14px]
                    max-[640px]:mt-3
                    max-[640px]:w-full
                    max-[640px]:text-[12px]">
